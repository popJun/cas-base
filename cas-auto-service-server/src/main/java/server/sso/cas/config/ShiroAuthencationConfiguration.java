...
import server.sso.cas.custom.handler.ShiroAuthenticationHandler;
...
public class ShiroAuthencationConfiguration implements AuthenticationEventExecutionPlanConfigurer{
    ...
    public AuthenticationHandler shiroAuthenticationHandler(){
        ShiroAuthenticationHandler shiroAuthenticationHandler = new ShiroAuthenticationHandler(ShiroAuthenticationHandler.class.getSimpleName(),servicesManager,new DefaultPrincipalFactory(),1);
